...
! function(e, t) {
	...
	var pe = function(e) {
		function t(e, n, i, a, s) {
			var o;
			return r(this, t), (o = f(this, l(t).call(this))).escaped = null == i || i, o.value = n || "", o.quote = e.charAt(0), o._index = a, o._fileInfo = s, o.variableRegex = /@\{([\w-]+)\}/g, o.propRegex = /\$\{([\w-]+)\}/g, o.allowRoot = i, o
		}
		return o(t, g), s(t, [{
			key: "genCSS",
			value: function(e, t) {
